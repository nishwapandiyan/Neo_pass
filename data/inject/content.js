...
function solveIamneoExamly(){
        ...
        // Send autoSolveQuestion signal to Gemini Sidebar
        try {
            const questionData = (typeof extractCurrentQuestion === 'function') ? extractCurrentQuestion() : null;
            if (questionData && typeof window.autoSolvePrompt === 'function') {
            ...
            console.log('[Gemini Sidebar] Auto solve trigger notice:', e.message);
        }
}
